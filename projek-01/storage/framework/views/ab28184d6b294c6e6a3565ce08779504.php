...
<body>
    ...
    <div class="container m-5">
        <h1>Tugas Web Personal</h1>
        <div class="list-group list-group-numbered mt-4">
        <a href="<?php echo e(url('/webpersonal')); ?>" class="list-group-item list-group-item-action">
            Web Personal
        </a>
        </div>
    </div>
    ...
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/user/1204220002')); ?>" class="list-group-item list-group-item-action">
...
<?php /**PATH C:\Penyimpanan Utama\Documnets\XAMPP\htdocs\Laravel\projek-01\resources\views/routing.blade.php ENDPATH**/ ?>