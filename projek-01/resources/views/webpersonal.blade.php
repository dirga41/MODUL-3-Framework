    ...
    >
      <div class="container">
        <a class="navbar-brand" href="https://www.instagram.com/dirasetya_41/">
            <img src="{{ Vite::asset('resources/css/image/logo.jpg') }}" alt="logo" width="50" height="44" class="d-inline-block align-text">
            Dirga Eka Prasetya
          </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/routing') }}">Back Routing</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <section id="heading" style="background-color: #292929;padding-top:10rem;">
      <div class = "container">
        <div class="row text-center mb 5">
          <div class="col">
            <img
        src="{{ Vite::asset('resources/css/image/foto.jpg') }}"
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="card" style="background-color: #a2a2a2">
              <img
                src="{{ Vite::asset('resources/css/image/html.jpg') }}"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
          ...
          <div class="col-md-4 mb-3 text-center">
            <div class="card" style="background-color: #a2a2a2">
              <img
                src="{{ Vite::asset('resources/css/image/css.jpg') }}"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
          ...
          <div class="col-md-4 mb-3 text-center">
            <div class="card" style="background-color: #a2a2a2">
              <img
                src="{{ Vite::asset('resources/css/image/python.jpg') }}"
                class="card-img-top"
                alt="..."
              />
              <div class="card-body">
